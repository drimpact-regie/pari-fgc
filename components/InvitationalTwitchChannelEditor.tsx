...
export default function InvitationalTwitchChannelEditor({
  eventId,
  initialChannel,
}: {
  eventId: string;
  ...
  return (
    <div className="flex items-center gap-2">
      <input
        ...
        autoFocus
      />
      <button type="button" onClick={handleSave} disabled={loading} className="text-xs font-semibold" style={{ color: "var(--accent)" }}>
        {loading ? "..." : "OK"}
      </button>
      <button
        type="button"
